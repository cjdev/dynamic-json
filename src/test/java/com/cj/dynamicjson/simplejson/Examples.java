...
public class Examples {
    ...
    public void findCheapestBookStream() {
      Optional<Double> price = MarshallerImpl.instance.parse(books).list().stream()
    ...
    public void findAllBooksWrittenByJim() {
        List<String> booksByJim = MarshallerImpl.instance.parse(books).list().stream()
    ...
    @Test
    public void toDto() {
        List<Book> bookObjects = MarshallerImpl.instance.parse(books).list().stream().map(mapper).collect(Collectors.toList());
